...
class TestDecoders(unittest.TestCase):
    ...
    def test_beam_search_decoder_1(self):
        ...
        beam_result, beam_scores, timesteps, out_seq_len, char_scores = decoder.decode(probs_seq)
    ...
    def test_beam_search_decoder_batch(self):
        ...
        beam_results, beam_scores, timesteps, out_seq_len, char_scores = decoder.decode(probs_seq)
